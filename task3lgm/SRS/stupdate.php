...
if (isset($_POST['sub'])) {
    ...
    $bnc = $_POST['brn'];
    $id1 = $_POST['id'];
    $spu = "SELECT st_reg  FROM student WHERE st_reg ='{$reg}'";

    $rpu = mysqli_query($con, $spu) or die("Query failed");

    if (mysqli_num_rows($rpu) > 0) {
            ...
            <div class="formbox">
                ...
                <form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
                    ...
                    ?>
                            ...
                            <input type="submit" name="sub" class="mybtn11" value="ADD">
                    <?php }
                    } ?>
                </form>
            </div>
