        ...
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form action="adminreg.php" method="POST">
                    ...
                    <input type="submit" name="submit" class="sign" value="Sign Up">
                </form>
            </div>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    <div class="overlay-panel overlay-left">
                        <button class="ghost sign" style="background:#f8f8f8" id="signIn">Login</button>
                    </div>
                    <div class="overlay-panel overlay-right">
                        <button class="ghost sign" style="background:#f8f8f8" id="signUp">Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
